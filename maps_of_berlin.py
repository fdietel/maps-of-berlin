...
# # Maps of Berlin
# In this notebook I will visualize some demographic and residential data of the population in Berlin in choropleth maps. The packages I will use for mapping are [GeoPandas](https://geopandas.org) and [Folium](http://python-visualization.github.io/folium/).
# 
...
# Finally, I have to compute the centroid of the Berlin-polygon. I will transform the projection from EPSG:4326 to EPSG:3035 (WGS 84). As can be seen below, EPSG:3035 is less distorted than EPSG:4326 and delivers a more precise centroid.
...
#Population residing at the same address for 10 or more years in %
