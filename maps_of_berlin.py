...
# # Maps of Berlin
# In this notebook I will visualize some demographic and residential data of the population in Berlin with choropleth maps. The packages I will use for mapping are [GeoPandas](https://geopandas.org) and [Folium](http://python-visualization.github.io/folium/).
# 
